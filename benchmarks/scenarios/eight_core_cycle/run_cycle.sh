...
WORK_DIR="${WORK_DIR:-$HOME/genro_bench/genropy-asgi/campaigns/$PREFIX}"
PLAN="${PLAN:-${PLAN_DIR:-$HOME/genro_bench/genropy-asgi/plans/eight_core_cycle}/cycle_plan.json}"
